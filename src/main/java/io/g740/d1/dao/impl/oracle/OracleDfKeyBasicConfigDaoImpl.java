 ...
 * @description :
 */
@Repository("OracleDfKeyBasicConfigDaoImpl")
public class OracleDfKeyBasicConfigDaoImpl implements DfKeyBasicConfigDao {

    private static final Logger LOGGER = LoggerFactory.getLogger(OracleDfKeyBasicConfigDaoImpl.class);
