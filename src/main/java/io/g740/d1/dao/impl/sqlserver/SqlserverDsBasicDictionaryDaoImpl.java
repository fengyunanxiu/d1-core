 ...
 * @description :
 */
@Repository("SqlserverDsBasicDictionaryDaoImpl")
public class SqlserverDsBasicDictionaryDaoImpl implements DsBasicDictionaryDao {

    private static final Logger LOGGER = LoggerFactory.getLogger(SqlserverDsBasicDictionaryDaoImpl.class);
