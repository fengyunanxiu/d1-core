 ...
 */
@Repository
public class DsBasicDictionaryDaoImpl implements DsBasicDictionaryDao {

    private static final Logger LOGGER = LoggerFactory.getLogger(DsBasicDictionaryDaoImpl.class);
