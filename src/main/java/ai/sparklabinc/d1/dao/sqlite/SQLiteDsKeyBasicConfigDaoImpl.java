 ...
 * @description :
 */
@Repository("SQLiteDsKeyBasicConfigDaoImpl")
public class SQLiteDsKeyBasicConfigDaoImpl implements DsKeyBasicConfigDao {

    private static final Logger LOGGER = LoggerFactory.getLogger(SQLiteDsKeyBasicConfigDaoImpl.class);
