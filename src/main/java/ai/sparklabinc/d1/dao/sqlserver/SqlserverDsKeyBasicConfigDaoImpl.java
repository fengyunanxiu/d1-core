 ...
 * @description :
 */
@Repository("SqlserverDsKeyBasicConfigDaoImpl")
public class SqlserverDsKeyBasicConfigDaoImpl implements DsKeyBasicConfigDao {

    private static final Logger LOGGER = LoggerFactory.getLogger(SqlserverDsKeyBasicConfigDaoImpl.class);
