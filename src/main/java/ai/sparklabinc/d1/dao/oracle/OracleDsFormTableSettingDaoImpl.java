 ...
 * @description :
 */
@Repository("OracleDsFormTableSettingDaoImpl")
public class OracleDsFormTableSettingDaoImpl implements DsFormTableSettingDao {

    private static final Logger LOGGER = LoggerFactory.getLogger(OracleDsFormTableSettingDaoImpl.class);
    @Autowired
