package ai.sparklabinc.d1.dao.impl.postgres;
 ...
 * @description :
 */
@Repository("PostgresqlDfKeyBasicConfigDaoImpl")
public class PostgresqlDfKeyBasicConfigDaoImpl implements DfKeyBasicConfigDao {

    private static final Logger LOGGER = LoggerFactory.getLogger(PostgresqlDfKeyBasicConfigDaoImpl.class);
