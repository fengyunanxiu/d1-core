 ...
 * @description :
 */
@Repository("SQLiteDfKeyBasicConfigDaoImpl")
public class SQLiteDfKeyBasicConfigDaoImpl implements DfKeyBasicConfigDao {

    private static final Logger LOGGER = LoggerFactory.getLogger(SQLiteDfKeyBasicConfigDaoImpl.class);
