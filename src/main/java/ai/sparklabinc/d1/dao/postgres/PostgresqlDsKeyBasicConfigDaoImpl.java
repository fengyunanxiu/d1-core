 ...
 * @description :
 */
@Repository("PostgresqlDsKeyBasicConfigDaoImpl")
public class PostgresqlDsKeyBasicConfigDaoImpl implements DsKeyBasicConfigDao {

    private static final Logger LOGGER = LoggerFactory.getLogger(PostgresqlDsKeyBasicConfigDaoImpl.class);
