 ...
 * {@linkplain ErrorCode.CommonApiErrorCode} which represent
 * an Unknown Error.
 *
 * @author Ali Dehghani
 */
...
public class ErrorCodes {
     ...
     *
     * @param e The exception to find the implementation based on that
     * @return An instance of {@linkplain ErrorCode} corresponding the given
     * {@code exception}
     */
    ErrorCode of(Exception e) {
        return implementions().filter(impl -> impl.canHandle(e))
                .findFirst()
